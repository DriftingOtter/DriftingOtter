...
![x86 Assembly](https://img.shields.io/badge/x86%20Assembly-525252?style=flat-square&logoColor=white)
...
- 🔗 [**Quantum Oscillators & The Hydrogen Atom**](https://github.com/DriftingOtter/Quantum-Oscillator-and-The-Hydrogen-Atom) — Interactive simulations of the QHO and Hydrogen Atom derived from first principles, with asymptotic analysis bridging quantum and classical behaviour
- 🔗 [**RU Makerverse**](https://github.com/DriftingOtter/RU-Makerverse) — Full-stack 3D printing management platform (React, Node.js, Snowflake SQL, Firebase, Gemini AI)
- 🔗 [**Project Resonator**](https://driftingotter.github.io/Project-Resonator-Web/) — Open-source in-ear monitor engineering, 4-driver crossover design, 30K+ views, $1,500+ seed funding
- 🔗 [**EarCanvas**](https://github.com/DriftingOtter/EarCanvas) — Real-time DSP engine in C, 48 kHz at 128 samples, ~0.10 ms processing latency
- 🔗 [**Clamshell**](https://crates.io/crates/clamshell) — Rust CLI task management tool, 7,000+ downloads
...
- 🏅 [IBM Quantum: Basics of Quantum Information](https://www.credly.com/badges/30038ab0-64eb-4ecb-82b4-a42639bdc9ab/public_url)
